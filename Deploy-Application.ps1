...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationProgress -StatusMessage "Installing Microsoft Visio. Please wait..."
		$exitCode = Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure Visio2019x64.xml" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationProgress -StatusMessage "Uninstalling Microsoft Visio 2019. Please wait..."
		$exitCode = Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure UninstallVisio2019.xml" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode.ExitCode -ne "3010")) {
			$mainExitCode = $exitCode.ExitCode
		}
